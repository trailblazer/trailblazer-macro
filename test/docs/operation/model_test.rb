...
class DocsModelTest < Minitest::Spec
  ...
  it do
    ...
    assert_equal result[:model].inspect, %{#<struct DocsModelTest::Song id=1, title=nil>}
...
class DocsModelFindByTitleTest < Minitest::Spec
  ...
  it do
    ...
    assert_equal result[:model].inspect, %{#<struct DocsModelFindByTitleTest::Song id=2, title="Test">}
  end
...
class DocsModelDependencyInjectionTest < Minitest::Spec
  ...
  it "allows injecting {:model.class} and friends" do
    ...
    assert_equal result[:model].inspect, %{#<struct DocsModelDependencyInjectionTest::Hit id=nil, title=nil>}
  ...
  # inject all variables
    ...
    assert_equal result[:model].inspect, %{#<struct DocsModelDependencyInjectionTest::Hit id=2, title="Olympia">}
end
...
class DocsModelEmptyDITest < Minitest::Spec
  ...
  it do
    result = Song::Operation::Create.(params: {}, :"model.class" => Hit, seq: [])
    assert_equal result[:model].inspect, %{#<struct DocsModelDependencyInjectionTest::DocsModelEmptyDITest::Hit id=nil, title=nil>}
  end
end
...
class DocsModelIOTest < Minitest::Spec
  ...
  it "allows to use composable I/O with macros" do
    ...
    assert_equal result[:model].inspect, %{#<struct DocsModelDependencyInjectionTest::DocsModelIOTest::Hit id=1, title=nil>}
=begin
#:in-call
