...
class NestedRescueTest < Minitest::Spec
  ...
  it { Trailblazer::Operation::Inspect.(NestedInsanity).must_match %r/.*>Rescue.*(>nested\/e).*(<<nested\/failure)/ } # FIXME: better introspect tests for all id-generating macros.
